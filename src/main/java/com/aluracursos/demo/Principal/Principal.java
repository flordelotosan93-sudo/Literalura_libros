...
public class Principal {
    ...
    public Principal(AutorRepositorio autorRepository, LibroRepositorio libroRepository) {
    ...
    private DatosLIbro obtenerDatosLibro() {
        ...
        Resultados resultado = conversor.obtenerDatos(json, Resultados.class);
        ...
        DatosLIbro first = resultado.libros().get(0);
        return first;
    }
    ...
    private void buscarLibroPorTitulo() {
        ...
        if (libroBuscado.isEmpty()) {
            ...
            mostrarLibro(libroBuscado.get(0));
        } else {
